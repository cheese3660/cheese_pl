...
namespace cheese::io {
    ...
    void setForegroundColor(std::uint8_t r, std::uint8_t g, std::uint8_t b) {
        std::cout << ESCAPE << "[38;2;" << static_cast<std::uint16_t>(r) << ';' << static_cast<std::uint16_t>(g) << ';' << static_cast<uint16_t>(b) << 'm';
    }
    ...
    void setBackgroundColor(std::uint8_t r, std::uint8_t g, std::uint8_t b) {
        std::cout << ESCAPE << "[48;2;" << static_cast<std::uint16_t>(r) << ';' << static_cast<std::uint16_t>(g) << ';' << static_cast<uint16_t>(b) << 'm';
    }
    ...
    void setUnderlineColor(std::uint8_t r, std::uint8_t g, std::uint8_t b) {
        std::cout << ESCAPE << "[58;2;" << static_cast<std::uint16_t>(r) << ';' << static_cast<std::uint16_t>(g) << ';' << static_cast<uint16_t>(b) << 'm';
    }
